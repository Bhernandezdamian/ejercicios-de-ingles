...
const answers = ["since", "since", "since", "since", 
"for","for","for","for","for"
,"for","since","since","since","since" ];
...
function checkAnswers() {
  ...
  if (correct) {
    document.getElementById("result").innerHTML = "¡Todas las respuestas son correctas! Felicidades.Ejercicio 6";
