...
const answers = ["have never drove", "has never broken", "has never sold", "have never worn", 
...
function checkAnswers() {
  ...
  if (correct) {
    document.getElementById("result").innerHTML = "¡Todas las respuestas son correctas! Felicidades.Ejercicio 3";
