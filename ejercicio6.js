...
"has followed","have worked","has never arrived","have been","has swum"
,"has never stolen"
    ];
...
function checkAnswers() {
  ...
  if (correct) {
    document.getElementById("result").innerHTML = "¡Todas las respuestas son correctas! Felicidades.Ejercicio 4";
