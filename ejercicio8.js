...
const answers = ["has been", "since", "has been", "for", 
"have not seen","since","have not seen","for","has been"
,"since","has been","for","have been","since" ,"have gone" ,"has climbed"
, "for"       ];
...
function checkAnswers() {
  ...
  const userAnswers = [
    ...
    document.getElementById("exercise16").value.toLowerCase(),
    document.getElementById("exercise17").value.toLowerCase(),
  ...
  if (correct) {
    document.getElementById("result").innerHTML = "¡Todas las respuestas son correctas! Felicidades.Ejercicio 7";
